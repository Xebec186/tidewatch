...
const mockNotifications = [
  {
    ...
    message: "Tide levels are approaching the danger threshold at Harbor Gate.",
    time: "5m ago",
    read: false,
  },
  {
    ...
    type: "info",
    title: "System Update",
    message: "TideWatch v2.4.0 is now live with improved telemetry charts.",
    time: "2h ago",
    read: true,
  },
  {
    ...
    message:
      "Station 04 battery has returned to optimal levels after charging.",
    time: "Yesterday",
    read: true,
  },
  {
    ...
    message:
      "Lost connection to pressure sensor at South Pier. Investigating...",
    time: "Yesterday",
    read: true,
  },
];
